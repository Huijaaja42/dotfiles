...
vim.keymap.set('n', '<S-ScrollWheelUp>', '')
vim.keymap.set('n', '<C-ScrollWheelUp>', '')
vim.keymap.set('n', '<ScrollWheelDown>', '')
vim.keymap.set('n', '<S-ScrollWheelDown>', '')
vim.keymap.set('n', '<C-ScrollWheelDown>', '')
vim.keymap.set('n', '<ScrollWheelLeft>', '')
vim.keymap.set('n', '<S-ScrollWheelLeft>', '')
vim.keymap.set('n', '<C-ScrollWheelLeft>', '')
vim.keymap.set('n', '<ScrollWheelRight>', '')
vim.keymap.set('n', '<S-ScrollWheelRight>', '')
vim.keymap.set('n', '<C-ScrollWheelRight>', '')
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>co', quickfix, '[C]ode [O]rganize')
